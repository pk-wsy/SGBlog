...
public class SystemLoginServiceImpl implements LoginService {
    ...
    public ResponseResult login(User user) {
        ...
        redisCache.setCacheObject(SystemConstants.ID_PREFIX_BACK+id,loginUser);
        //将用户信息封装至vo对象中
    ...
    public ResponseResult logout() {
        //由于是在已经登录的状态，因此查询SecurityContextHolder中的id
        String userId = SecurityUtils.getUserId().toString();
        //删除redis中存储的数据
        redisCache.deleteObject(SystemConstants.ID_PREFIX_BACK+userId);
